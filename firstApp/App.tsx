...
import { StyleSheet, Text, View, TextInput, Button, Image, ScrollView, SafeAreaView, Animated, ViewStyle, StyleProp, ImageSourcePropType, Pressable } from 'react-native'; 
...
function SpringPop({ children }: { children: ReactNode }) {
